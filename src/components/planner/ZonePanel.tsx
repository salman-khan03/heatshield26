        ...
        <div className="rounded-xl border border-line-strong bg-panel-2 p-3">
          ...
          {explain.state === "done" && (
            <div className="rise mt-3 rounded-lg border border-line bg-ink p-3">
              ...
              <div className="mt-2 text-[10.5px] uppercase tracking-wider text-faint">{explain.source === "claude" ? "Generated by Claude from the facts shown in this panel" : "Template explanation — set ANTHROPIC_API_KEY to enable Claude"}</div>
            </div>
          )}
