        ...
        <div className="rounded-xl border border-line-strong bg-panel-2 p-3">
          ...
          {explain.state === "done" && (
            <div className="rise mt-3 rounded-lg border border-line bg-ink p-3">
              ...
              <div className="mt-2 text-[10.5px] uppercase tracking-wider text-faint">{explain.source === "gemini" ? "Generated by Gemini from the facts shown in this panel" : explain.source === "groq" ? "Generated via Groq from the facts shown in this panel" : "Template explanation — set GEMINI_API_KEY or GROQ_API_KEY to enable AI"}</div>
            </div>
          )}
